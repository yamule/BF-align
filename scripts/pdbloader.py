        ...
        for li in range(len(alllines)):
            ...
            if head == "ATOM  " or head == "HETATM":
                ...
                if att.chain_id in chain_ended or chain_ended_all:
                    ...
                    if head == "ATOM  ":
                        sys.stderr.write("ATOM line was found after TER.\nCheck your format or change loader script.\n");
                else:
            ...
            if head == "ENDMDL":
                if li != len(alllines) -1:
                    flag = False;
                    for jj in range(li,len(alllines)):
                        if alllines[jj].startswith
                    sys.stderr.write("ENDMDL line was found befo \n");
